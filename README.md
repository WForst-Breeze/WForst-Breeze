...
- 请尽量不要完全照搬，作为您的个人主页，更应该体现您的特色和态度~！例如这个文件的开头，就是我写的随笔中的节选，也正是我生活态度的体现。
- 您在借鉴此文件时，如果可以，请务必在这个仓库的 Issue 或其他渠道通知我。
- 您可以随意借鉴这个文件中的所有元素而无需标识。
以上两条并非硬性要求，也就是说，您完全可以不这样做。我很乐意看见别人喜欢我的作品，因此如果您告知了我，我会过去捧捧场的！
  --->
